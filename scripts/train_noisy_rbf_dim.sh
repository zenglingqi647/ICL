...
python train.py --config conf/rbf_lr_noise0.1_dim10.yaml &
sleep 2
python train.py --config conf/rbf_lr_noise0.1_dim30.yaml &
sleep 2
python train.py --config conf/rbf_lr_noise0.1_dim40.yaml &
sleep 2
wait
